@include('sidebar1')
 ...
 <div class="page">
  ...
  <div class="page-header">
    <div>
        <h1 class="page-title">Employee Individual  Records</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0);">Personnel</a></li>
            <li class="breadcrumb-item active" aria-current="page">Indiviual  Record</li>
        </ol>
    </div>
  <div class="col-lg-4">
    <div class="">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
      ...
      <div class="card">
			<div class="card-header">
				<h3 class="card-title"> <i class="side-menu__icon fe fe-users"> Employee Individual  Records</i></h3>
        ...
        <div class="card-body">
          <h5 class="card-title"></h5>
            ...
            <tbody>
                @foreach($individualRecord as $result)
              <tr>
