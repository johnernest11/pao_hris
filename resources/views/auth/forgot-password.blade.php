      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <form class="row g-3 needs-validation" action="{{route('password.request')}}" method="post" novalidate>
                  ...
                  <div class="separator"> </div>
                  <label for="yourPassword" class="form-label">Request Password Reset | PAO-HRIS </label>
                  <div class="separator"> </div>
                  <div class="col-12">
